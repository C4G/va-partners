...
const renderReferencePage = () => {
  return (
    <table border="1" className="beneficiary-table table-bordered table">
      <thead>
        <tr>
          <th>S.no</th>
          <th>Programs</th>
      ...
      <tbody>
        <tr>
          ...
          <td>
            Low vision screening of the school of the blind and Identification of the visually impaired for assistive
            technology
          </td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td></td>
          <td>
            Age group less than 7 years. Training of infants, children and parents to improve the brain’s ability to use
            and interpret visual information especially in kids with Cortical visual impairment (CVI)
          </td>
        </tr>
        <tr>
          <td>4</td>
          ...
          <td></td>
          <td>
            Low vision assessment / Functional vision assessment done by a Professional - Optometrist / Low vision care
        ...
        <tr>
          ...
          <td></td>
          <td>
            Training programs are conducted to build proficiency in computer skills using assistive technology like
            screen readers, magnification and contrast modifications
          </td>
        </tr>
        <tr>
          <td>10</td>
