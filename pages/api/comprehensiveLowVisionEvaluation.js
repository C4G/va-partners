...
async function deleteData(req, res) {
  const body = req.body;
  try {
    const comp_eval = await prisma.comprehensive_Low_Vision_Evaluation.delete({
      where: { id: body.id },
    });
...
async function addData(req, res) {
  ...
  const create = {
    data: {
      ...
      dispensedSpectacle: body.dispensedSpectacle.join("; "),
      ...
      dispensedOptical: body.dispensedOptical.join("; "),
      ...
      dispensedNonOptical: body.dispensedNonOptical.join("; "),
      ...
      dispensedElectronic: body.dispensedElectronic.join("; "),
