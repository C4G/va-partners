...
export default async function handler(req, res) {
  ...
  await updateUserLastModified("beneficiaryList", req.method, session.user.email);
  if (req.method !== "GET") {
...
async function fetchData(req, res) {
  try {
    ...
    const beneficiaryList = beneficiaryListFromAPI.map((beneficiary) => ({
      ...
      comprehensiveLowVisionEvaluation: beneficiary.Comprehensive_Low_Vision_Evaluation,
